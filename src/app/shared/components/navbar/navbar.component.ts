      ...
      <div 
        ...
        <div class="flex items-center justify-between">
          ...
          <a routerLink="/" class="flex items-center gap-3 group cursor-pointer select-none">
            <div class="relative w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-gradient-to-tr from-brand-700 via-brand-600 to-red-500 flex items-center justify-center text-white shadow-md transform group-hover:scale-105 transition-transform duration-300">
