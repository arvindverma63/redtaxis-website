...
interface BenefitItem {
  title: string;
  desc: string;
  iconType: 'bolt' | 'map' | 'cash' | 'shield' | 'radar' | 'chart';
}
    ...
    <div class="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col transition-colors duration-300 overflow-x-hidden font-sans">
      ...
      <section class="relative pt-6 sm:pt-10 pb-20 px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-center overflow-hidden border-b border-slate-200 dark:border-slate-800">
        ...
        <div class="max-w-7xl mx-auto w-full relative z-10 flex flex-col items-center text-center space-y-8">
          ...
          <div class="w-full max-w-2xl pt-4 relative select-none">
            ...
            <div class="absolute -left-2 sm:left-2 top-1/3 hidden sm:flex items-center gap-2.5 p-2.5 rounded-2xl bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border border-slate-200/90 dark:border-slate-800 shadow-xl animate-float-badge-left">
              ...
              <div class="text-left pr-2">
                <div class="text-[10px] font-bold text-slate-900 dark:text-white">Driver Matched</div>
                <div class="text-[9px] text-slate-500 dark:text-slate-400">0.8 km • 2 min ETA</div>
              </div>
            </div>
            ...
            <div class="absolute -right-2 sm:right-2 bottom-1/4 hidden sm:flex items-center gap-2.5 p-2.5 rounded-2xl bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border border-slate-200/90 dark:border-slate-800 shadow-xl animate-float-badge-right">
              ...
              <div class="text-left pr-2">
                <div class="text-[10px] font-bold text-slate-900 dark:text-white">Zero Surge Fare</div>
                <div class="text-[9px] text-emerald-600 dark:text-emerald-400 font-semibold">100% Locked Price</div>
              </div>
            </div>
          ...
          <div class="pt-4 flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-xs text-slate-500 dark:text-slate-400 font-medium select-none">
            <div class="flex items-center gap-2">
              <span class="w-2 h-2 rounded-full bg-emerald-500"></span>
              <span>Sub-second GPS matching</span>
            </div>
            <div class="flex items-center gap-2">
      ...
      <!-- AUTONOMOUS AI DISPATCH ASSISTANT & CAD TELEMETRY SECTION (DYNAMIC CAROUSEL & ANIMATED STREAM) -->
      <section class="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div class="rounded-3xl p-6 sm:p-10 lg:p-12 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl space-y-8 relative overflow-hidden">
          ...
          <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-slate-200 dark:border-slate-800 relative z-10">
            <div class="space-y-2">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch relative z-10">
            ...
            <div class="lg:col-span-5 flex flex-col justify-between space-y-4">
              ...
              <div class="p-5 sm:p-6 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-200/80 dark:border-slate-800 shadow-sm hover:border-slate-400 dark:hover:border-slate-700 hover:shadow-md transition-all space-y-2.5">
                <div class="flex items-center justify-between">
                  ...
                  <span class="text-[11px] font-mono font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800/50 px-2 py-0.5 rounded-md">
                    {{ liveLatency }}ms Latency
                  </span>
                </div>
                <p class="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  Real-time 60fps tracking with continuous vehicle heading gyro and road network snapping.
                </p>
                <div class="flex items-center gap-2 pt-1 text-[10px] font-bold text-slate-500 dark:text-slate-400">
                  ...
                  <span class="px-2 py-0.5 rounded bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">● {{ activeCabsCount }} Active Cabs</span>
                </div>
              </div>
            ...
            <div class="lg:col-span-7 flex flex-col rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white shadow-lg dark:shadow-2xl relative min-h-[540px] justify-between transition-colors">
              ...
              <!-- Top Console HUD Bar with Live Auto-Carousel Progress -->
              <div class="bg-white/95 dark:bg-slate-900/90 backdrop-blur-md px-5 py-3.5 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between z-20 transition-colors relative">
                
                <!-- Auto-Cycling Progress Bar -->
                <div class="absolute bottom-0 left-0 h-0.5 bg-brand-600 transition-all duration-100 ease-linear" [style.width.%]="progress"></div>
              ...
              <div class="p-6 sm:p-7 flex-1 flex flex-col justify-between space-y-6 relative z-10">
                ...
                <!-- Center Core: Driver AI Assistant Photo & Interactive Streaming Dialogue -->
                <div class="grid grid-cols-1 md:grid-cols-12 gap-5 items-center pb-1">
                  ...
                  <div class="md:col-span-5 relative rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm group">
                    ...
                    <div class="absolute inset-0 pointer-events-none overflow-hidden">
                      <div class="w-full h-8 bg-gradient-to-b from-transparent via-brand-500/30 to-transparent animate-pulse-subtle"></div>
                    </div>
                  ...
                  <!-- Assistant State & Animated Streaming Dialogue Card -->
                  <div class="md:col-span-7 space-y-2.5 text-left">
                    <div class="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <div class="flex items-center gap-1.5">
                        <button 
                          *ngFor="let s of aiScenarios; let i = index"
                          (click)="selectScenario(i, true)"
                          [ngClass]="selectedScenarioIndex === i ? 'w-5 bg-brand-600' : 'w-1.5 bg-slate-300 dark:bg-slate-700'"
                    ...
                    <div class="p-3.5 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 text-left space-y-2 shadow-sm min-h-[105px]">
                      ...
                      <div class="pt-2 border-t border-slate-100 dark:border-slate-800 flex items-start gap-2.5">
                        ...
                        <p class="text-xs sm:text-sm text-slate-700 dark:text-slate-200 leading-relaxed font-sans">
                          {{ displayedResponse }}
                          <span class="inline-block w-1.5 h-3 bg-brand-500 ml-0.5 animate-cursor"></span>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <!-- Interactive Scenario Carousel Buttons -->
                <div class="pt-1">
                  <div class="text-[11px] font-mono text-slate-500 dark:text-slate-400 uppercase font-bold mb-2 flex items-center justify-between">
                    <span>⚡ Live Copilot Scenarios (Auto-Playing):</span>
                    <span class="text-[10px] text-brand-600 dark:text-brand-400 font-semibold">Click to switch or pause</span>
                  </div>
                  ...
                  <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    <button 
                      *ngFor="let s of aiScenarios; let i = index"
                      (click)="selectScenario(i, true)"
                      [ngClass]="selectedScenarioIndex === i ? 'bg-brand-600 text-white border-brand-600 shadow-md shadow-brand-600/20' : 'bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 shadow-xs'"
              ...
              <div class="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md px-5 py-3 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-[11px] z-20 transition-colors">
                <div class="flex items-center gap-2 text-slate-600 dark:text-slate-300 truncate">
                  <span class="text-brand-600 dark:text-brand-400 font-bold">● Live Telemetry Stream:</span>
                  <span class="truncate text-slate-500 dark:text-slate-400">Autonomous CAD agent monitoring {{ activeCabsCount }} active cabs across Coimbatore Metro</span>
                </div>
      ...
      <!-- MODULAR SOFTWARE SUITE SECTION (CONSISTENT REALISTIC UI PHOTOS & CLEAR BENEFIT CARDS) -->
        ...
        <div class="max-w-7xl mx-auto">
          ...
          <div class="text-center max-w-3xl mx-auto mb-14 space-y-3">
            ...
            <p class="text-sm sm:text-base text-slate-600 dark:text-slate-400">
              Native driver terminals, passenger mobile apps, and autonomous cloud dispatch consoles — fully powered by Red Taxis.
            </p>
          </div>

          <!-- 3-Column Visual Software Module Cards (Consistent Photo UI & Clear Benefits) -->
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            ...
            <div 
              *ngFor="let mod of softwareModules"
              ...
              <!-- Card Top Image Container with High-Res SaaS Visual (Consistent Photo UI) -->
              <div class="relative h-56 sm:h-60 bg-slate-100 dark:bg-slate-950 overflow-hidden group">
                ...
                <!-- Clean Category Pill (No Rating Badge) -->
                <div class="absolute top-3.5 left-3.5 backdrop-blur-md bg-slate-950/85 text-white px-3 py-1 rounded-full text-xs font-bold shadow-md flex items-center gap-1.5 z-10">
                  <span class="w-2 h-2 rounded-full bg-emerald-500"></span>
                  <span>{{ mod.badge }}</span>
                </div>

                <!-- Product Platform Pill -->
                <div class="absolute bottom-3.5 right-3.5 backdrop-blur-md bg-brand-600/90 text-white px-3 py-1 rounded-xl text-xs font-bold shadow-md z-10">
                  {{ mod.category }}
                </div>
              </div>
              ...
              <div class="p-6 sm:p-7 flex-1 flex flex-col justify-between space-y-5">
                ...
                <!-- Clear, Understandable 3-Benefit Cards Grid -->
                <div class="grid grid-cols-1 gap-2.5 py-1">
                  <div 
                    *ngFor="let ben of mod.benefits" 
                    class="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-950/80 border border-slate-200/70 dark:border-slate-800 flex items-center gap-3 text-left">
                    <div class="w-7 h-7 rounded-lg bg-red-50 dark:bg-red-950/50 border border-red-100 dark:border-red-900/40 text-brand-600 dark:text-brand-400 flex items-center justify-center shrink-0">
                      <!-- Bolt -->
                      <svg *ngIf="ben.iconType === 'bolt'" class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/>
                      </svg>
                      <!-- Map -->
                      <svg *ngIf="ben.iconType === 'map'" class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"/>
                        <line x1="9" y1="3" x2="9" y2="18"/>
                        <line x1="15" y1="6" x2="15" y2="21"/>
                      </svg>
                      <!-- Cash -->
                      <svg *ngIf="ben.iconType === 'cash'" class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <rect x="2" y="5" width="20" height="14" rx="2"/>
                        <line x1="2" y1="10" x2="22" y2="10"/>
                      </svg>
                      <!-- Shield -->
                      <svg *ngIf="ben.iconType === 'shield'" class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
                      </svg>
                      <!-- Radar -->
                      <svg *ngIf="ben.iconType === 'radar'" class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="10"/>
                        <circle cx="12" cy="12" r="6"/>
                        <circle cx="12" cy="12" r="2"/>
                      </svg>
                      <!-- Chart -->
                      <svg *ngIf="ben.iconType === 'chart'" class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <div>
                      <div class="text-xs font-bold text-slate-900 dark:text-white">{{ ben.title }}</div>
                      <div class="text-[11px] text-slate-500 dark:text-slate-400">{{ ben.desc }}</div>
                    </div>
                  </div>
                </div>

                <!-- Feature Highlights -->
                <ul class="space-y-2 text-xs text-slate-600 dark:text-slate-300 font-sans border-t border-slate-100 dark:border-slate-800/80 pt-3">
          ...
          <div class="mt-12 p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center shadow-sm">
            ...
            <div class="flex items-center justify-center sm:justify-start gap-3.5">
              ...
              <div class="text-left">
                ...
                <div class="text-[11px] text-slate-500">Instant tenant provisioning with cloud database</div>
              </div>
            </div>

            <div class="flex items-center justify-center sm:justify-start gap-3.5">
              <div class="w-10 h-10 rounded-2xl bg-slate-100 dark:bg-slate-800 border border-slate-200/60 dark:border-slate-700/60 text-brand-600 dark:text-brand-400 flex items-center justify-center shrink-0">
                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.92 6.01C18.72 5.42 18.16 5 17.5 5h-11c-.66 0-1.21.42-1.42 1.01L3 12v8c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1h12v1c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-8l-2.08-5.99zM6.5 16c-.83 0-1.5-.67-1.5-1.5S5.67 13 6.5 13s1.5.67 1.5 1.5S7.33 16 6.5 16zm11 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM5 11l1.5-4.5h11L19 11H5z"/>
                </svg>
              </div>
              <div class="text-left">
                <div class="text-xs font-black text-slate-900 dark:text-white">Powered by Red Taxis OS</div>
                <div class="text-[11px] text-slate-500">Unified fleet operating system & central network</div>
              </div>
            </div>
...
export class WebsiteComponent implements OnInit, OnDestroy {
  ...
  get currentScenario(): AiScenario {
    return this.aiScenarios[this.selectedScenarioIndex] || this.aiScenarios[0];
  }

  ngOnInit(): void {
    this.startStreaming(this.currentScenario.response);
    this.startAutoCarousel();
    
    // Slight telemetry latency jitter for realistic live feel
    this.latencyInterval = setInterval(() => {
      this.liveLatency = Math.floor(Math.random() * 5) + 10; // 10 to 14ms
      this.activeCabsCount = 18 + (Math.random() > 0.5 ? 1 : 0);
    }, 3000);
  }
  ...
  selectScenario(index: number, isUserClick = false): void {
    if (this.selectedScenarioIndex === index && !isUserClick) return;
  ...
  private startStreaming(fullText: string): void {
    ...
    this.typeInterval = setInterval(() => {
      if (charIndex < fullText.length) {
        this.displayedResponse += fullText.charAt(charIndex);
        charIndex++;
      } else {
  ...
  private startAutoCarousel(): void {
    ...
    this.progressInterval = setInterval(() => {
      ...
      if (this.progress >= 100) {
        this.progress = 0;
        const nextIndex = (this.selectedScenarioIndex + 1) % this.aiScenarios.length;
        this.selectScenario(nextIndex, false);
      }
    }, stepMs);
  }

  private restartAutoCarousel(): void {
    this.stopTimers();
    this.startAutoCarousel();
  }
  ...
  softwareModules: SoftwareModule[] = [
    {
      ...
      benefits: [
        ...
        { iconType: 'map', title: 'Turn-by-Turn GPS Map', desc: 'Real-time traffic choke avoidance' },
        { iconType: 'cash', title: 'Daily Bank Payouts', desc: 'Automated direct UPI settlement' }
      ],
      highlights: [
        'Live turn-by-turn route navigation',
        'Cryptographic 4-digit rider OTP handshake',
        'Flexible shift duty toggle (Online/Offline)',
        'Offline queue sync with zero dropped rides'
      ],
      routeLink: '/client',
    ...
    },
    {
      ...
      category: 'Mobile & Web Booking',
      tagline: 'Custom rider mobile apps & web booking engine built for high conversion',
      image: '/assets/app-screens.jpg',
      badge: 'Passenger App',
      benefits: [
        { iconType: 'bolt', title: 'Fast 3s Cab Matching', desc: 'Snaps nearest available driver' },
        { iconType: 'shield', title: 'Zero Surge Guarantee', desc: 'Transparent locked upfront fares' },
        { iconType: 'cash', title: 'Cash, Cards & UPI', desc: 'Seamless in-app digital wallet' }
      ],
      highlights: [
        'Live vehicle radar tracking on map',
        'Scheduled airport & outstation bookings',
        'Real-time SOS & emergency trip sharing',
    ...
    },
    {
      ...
      badge: 'Fleet Console',
      benefits: [
        { iconType: 'radar', title: 'Live Fleet Map Radar', desc: 'Every cab tracked on screen in real time' },
        { iconType: 'bolt', title: 'Auto-Dispatch Engine', desc: 'Algorithmic allocation without manual calls' },
        { iconType: 'chart', title: 'GST & Profit Ledger', desc: 'Automated invoicing & financial audit' }
      ],
      highlights: [
        'Geospatial proximity cluster auto-dispatch',
        'Driver shift audit & remote terminal lock',
        'Multi-region 99.99% cloud reliability',
        'Unified fleet telemetry & performance logs'
      ],
      routeLink: '/admin',
